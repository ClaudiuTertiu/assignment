...
public interface AccountService {
    ...
    void updateEmail(int accountNumber, String newEmail);
    void updatePremiumAmount(double percentage, String policyName);
    int noOfExpiredPremiumAccounts(Account account);
    int displayMaxAssuredAmount();
    List<Account> filterAccount(String state, String policyName);
    List<Account> filterAccount(String state, int premiumAmount, int balance);
    Set<String> extractEmailsWithoutPolicy();
}
